...
import { LAYOUT, EXCEPTION_COMPONENT, PAGE_NOT_FOUND_NAME, REDIRECT_NAME } from '@jeesite/core/router/constant';
...
export default [PAGE_NOT_FOUND_ROUTE, ERROR_LOG_ROUTE, REDIRECT_ROUTE];
